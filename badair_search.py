...
def realtime_search(service_key):
    ...
    url2 = "http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getUnityAirEnvrnIdexSnstiveAboveMsrstnList?serviceKey=" + service_key + "&numOfRows=10&pageSize=10&pageNo=1&startPage=1"
